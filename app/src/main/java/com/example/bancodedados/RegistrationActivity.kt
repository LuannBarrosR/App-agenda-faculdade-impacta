...
import com.example.bancodedados.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnVoltarAgenda.setOnClickListener {
            val navegarTelaHomeAgenda = Intent(this, MainActivity::class.java)
            startActivity(navegarTelaHomeAgenda)
        }
